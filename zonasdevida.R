...
####################INICIO###############################
# Read necessary data
ap<- raster("F:/COBERTURAS/CLIMA_ANGELA/CONANP/Bioclimas/Bios(1980-2009)_tiff_g/p3bio12.tif") ##Raster precipitation (mm)
at <-raster("F:/COBERTURAS/CLIMA_ANGELA/CONANP/Bioclimas/Bios(1980-2009)_tiff_g/p3bio01.tif")
