...
DAN_estables45.mexbio <- DAN_estables45[which(DAN_estables45$MEXBIO_2010_gw_pr <= 0.6617800),]
DAN_cambio45 <- subset(cambio45, ecoregiones == 10)
DAN_cambio45.mexbio <- DAN_cambio45[which(DAN_cambio45$MEXBIO_2010_gw_pr <= 0.6617800),]

CM_estables45 <- subset(estables45, ecoregiones == 11)
CM_estables45.mexbio <- CM_estables45[which(CM_estables45$MEXBIO_2010_gw_pr <= 0.6300000),]
CM_cambio45 <- subset(cambio45, ecoregiones == 11)
CM_cambio45.mexbio <- CM_cambio45[which(CM_cambio45$MEXBIO_2010_gw_pr <= 0.6300000),]
...
write.csv(alto.mexbio.estables45, "Resample/HAD_ESM_LR_rcp45_2015_2039_bio/median_mexbio/alto_mexbio_estables45.csv")
...
alto.mexbio.cambio45<-rbind(GP_cambio45.mexbio,DAN_cambio45.mexbio,
                       ...
                       SCH_cambio45.mexbio)
write.csv(alto.mexbio.cambio45, "Resample/HAD_ESM_LR_rcp45_2015_2039_bio/median_mexbio/alto_mexbio_cambio45.csv")
...
DAN_estables85.mexbio <- DAN_estables85[which(DAN_estables85$MEXBIO_2010_gw_pr <= 0.6617800),]
DAN_cambio85 <- subset(cambio85, ecoregiones == 10)
DAN_cambio85.mexbio <- DAN_cambio85[which(DAN_cambio85$MEXBIO_2010_gw_pr <= 0.6617800),]

CM_estables85 <- subset(estables85, ecoregiones == 11)
CM_estables85.mexbio <- CM_estables85[which(CM_estables85$MEXBIO_2010_gw_pr <= 0.6300000),]
CM_cambio85 <- subset(cambio85, ecoregiones == 11)
CM_cambio85.mexbio <- CM_cambio85[which(CM_cambio85$MEXBIO_2010_gw_pr <= 0.6300000),]
...
write.csv(alto.mexbio.estables85, "Resample/HAD_ESM_LR_rcp85_2015_2039_bio/median_mexbio/alto_mexbio_estables85.csv")
...
alto.mexbio.cambio85<-rbind(GP_cambio85.mexbio,DAN_cambio85.mexbio,
                            ...
                            SCH_cambio85.mexbio)
write.csv(alto.mexbio.cambio85, "Resample/HAD_ESM_LR_rcp85_2015_2039_bio/median_mexbio/alto_mexbio_cambio85.csv")